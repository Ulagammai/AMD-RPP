...
-------------------
  ...
  Determines the absolute difference of two images of each pixels from the corresponding pixel value. 
...
----------
  ...
  Accumulates an input image pixels into output image pixels.
